...
def solve_auxiliary_lp(A, b):

    _A, _b, _c, _basic, _non_basic = create_auxiliary(A, b)

    _z, _w, _xB, _basic, _status = solve(_A, _b, _c, _basic, _non_basic)

    if _z < 0 and _status is "optimal":
        return
    elif _z == 0 and _status is "optimal":
        return _xB, _basic, _non_basic
